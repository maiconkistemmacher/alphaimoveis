          ...
          <div class="col-12 col-md-10 d-none d-xl-block">
            <nav class="site-navigation position-relative text-right" role="navigation">
              ...
              <ul class="site-menu main-menu js-clone-nav mr-auto d-none d-lg-block">
                ...
                <li><a href="" class="nav-link">Imóveis</a></li>
                <li><a href="" class="nav-link">Clientes</a></li>
                <li><a href="" class="nav-link">Configurações</a></li><li class="nav-item"><a class="btn btn-outline-primary" href="index.php" role="button">Sair</a>
